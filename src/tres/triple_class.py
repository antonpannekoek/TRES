...
from tres import interactions
import tres.tidal_friction_constant as tfc
...
class Triple:
    ...
    def __init__(
        ...
        self.initialize_secular(
            secular_code, stop_at_semisecular_regime, stop_at_dynamical_instability
        )

        self.check_RLOF()
        if self.has_tertiary_donor() and (
            self.stop_at_outer_mass_transfer
            or self.stop_at_mass_transfer
            or self.stop_at_init_mass_transfer
        ):
            self.mass_transfer_at_initialisation = True
            self.triple.bin_type = interactions.bin_type["rlof"]
            return
        ...
        if (self.has_donor() or self.has_OLOF_donor()) and (
            ...
            if binary.child1.is_OLOF_donor or binary.child2.is_OLOF_donor:
                binary.bin_type = interactions.bin_type["olof"]
                return
            if binary.child1.is_donor and binary.child2.is_donor:
                binary.bin_type = interactions.bin_type["contact"]
                return
            binary.bin_type = interactions.bin_type["rlof"]
            return
    ...
    def initialize_secular(
        self, secular_code, stop_at_semisecular_regime, stop_at_dynamical_instability
    ):
        ...
        if (
            ...
            and codeparticles[0].dynamical_instability is True
        ):
        ...
        if (
            ...
            and codeparticles[0].semisecular_regime is True
        ):
    ...
    def copy_from_stellar(self):
        ...
        if options.GET_AMC_FROM_STELLAR_CODE:
        ...
        if stellar_system.is_star:
            if (
                ...
                if self.include_CHE:  # sets initial spin to corotation
                    ...
                    stellar_system.rotation_period = (
                        2 * np.pi / stellar_system.spin_angular_frequency
                    )
    ...
    def refresh_memory(self, stellar_system=None):
        ...
        if stellar_system.is_star:
            ...
            stellar_system.moment_of_inertia_of_star = (
                stellar_system.previous_moment_of_inertia_of_star
            )
            stellar_system.time_derivative_of_radius = (
                stellar_system.previous_time_derivative_of_radius
            )
            stellar_system.spin_angular_frequency = (
                stellar_system.previous_spin_angular_frequency
            )
    ...
    def update_time_derivative_of_radius(self, stellar_system=None):
        ...
        if self.triple.time == quantities.zero:
            # initialization
            self.triple.child2.child1.time_derivative_of_radius = (
                0.0 | units.RSun / units.yr
            )
            self.triple.child2.child2.time_derivative_of_radius = (
                0.0 | units.RSun / units.yr
            )
    ...
    def update_time_derivative_of_moment_of_inertia(self, stellar_system=None):
        ...
        if self.triple.time == quantities.zero:
            # initialization
            self.triple.child2.child1.time_derivative_of_moment_of_inertia = (
                0.0 | units.MSun * units.RSun**2 / units.yr
            )
            self.triple.child2.child2.time_derivative_of_moment_of_inertia = (
                0.0 | units.MSun * units.RSun**2 / units.yr
            )
            self.triple.child1.time_derivative_of_moment_of_inertia = (
                0.0 | units.RSun / units.yr
            )
        else:
            if stellar_system.is_star:
    ...
    def update_stellar_parameters(self, stellar_system=None):
        ...
        if stellar_system.is_star:
            ...
            stellar_system.moment_of_inertia_of_star = self.moment_of_inertia(
                stellar_system
            )
            ...
            if stellar_system.stellar_type in interactions.stellar_types_SN_remnants:
    ...
    def is_binary(self, stellar_system=None):
        ...
        return (
            not stellar_system.is_star
            and stellar_system.child1.is_star
            and stellar_system.child2.is_star
        )
    ...
    def is_triple(self, stellar_system=None):
        ...
        if not stellar_system.is_star:
            if stellar_system.child1.is_star and self.is_binary(stellar_system.child2):
                return True
            elif stellar_system.child2.is_star and self.is_binary(
    ...
    def has_donor(self, stellar_system=None):
        ...
        if stellar_system.is_star:
            ...
            if self.has_donor(stellar_system.child1) or self.has_donor(
    ...
    def has_OLOF_donor(self, stellar_system=None):
        ...
        if stellar_system.is_star:
            ...
            if self.has_OLOF_donor(stellar_system.child1) or self.has_OLOF_donor(
                stellar_system.child2
            ):
                return True
    ...
    def has_merger(self, stellar_system=None):
        ...
        if stellar_system.is_star:
            ...
            if self.has_merger(stellar_system.child2):
                return True
            if stellar_system.bin_type == interactions.bin_type["merger"]:
                return True
    ...
    def has_disintegrated(self, stellar_system=None):
        ...
        if stellar_system.is_star:
            ...
            if self.has_disintegrated(stellar_system.child2):
                return True
            if stellar_system.bin_type == interactions.bin_type["disintegrated"]:
                return True
    ...
    def has_dynamical_instability(self, stellar_system=None):
        ...
        if stellar_system.is_star:
            ...
            if self.has_dynamical_instability(stellar_system.child2):
                return True
            if stellar_system.bin_type == interactions.bin_type["dyn_inst"]:
                return True
    ...
    def set_bintype_to_dynamical_instability(self, stellar_system=None):
        if self.triple.dynamical_instability:
            ...
            if stellar_system.is_star is False:
                stellar_system.bin_type = interactions.bin_type["dyn_inst"]
    ...
    def has_tertiary_donor(self, stellar_system=None):
        ...
        if stellar_system.is_star:
            ...
            if self.has_tertiary_donor(stellar_system.child2):
                return True
            if (
                stellar_system.child1.is_star
                and stellar_system.child1.is_donor
                and not stellar_system.child2.is_star
            ):
                return True
            if (
                stellar_system.child2.is_star
                and stellar_system.child2.is_donor
                and not stellar_system.child1.is_star
            ):
                return True
        return False
    ...
    def contains_SN_remnant(self, stellar_system=None):
        ...
        if stellar_system.is_star:
            ...
            if self.contains_SN_remnant(
                stellar_system.child1
            ) or self.contains_SN_remnant(stellar_system.child2):
                return True
    ...
    def has_stellar_type_changed(self, stellar_system=None):
        ...
        if stellar_system.is_star:
            ...
            if self.has_stellar_type_changed(
                stellar_system.child1
            ) or self.has_stellar_type_changed(stellar_system.child2):
                return True
    ...
    def orbital_period(self, bs):
        if not bs.is_star:
            Porb = (
                2
                * np.pi
                * np.sqrt(bs.semimajor_axis**3 / constants.G / self.get_mass(bs))
            )
            return Porb
        else:
    ...
    def orbital_angular_momentum(self, bs):
        if not bs.is_star:
            ...
            if options.REPORT_BINARY_EVOLUTION:
    ...
    def apsidal_motion_constant(self, star):
        ...
        if star.stellar_type in [13] | units.stellar_type:  # ns
            ...
            star.stellar_type in [1, 7, 10, 11, 12] | units.stellar_type
        ):  # ms, he-ms, wd
    ...
    def octupole_parameter(self):
        if self.is_triple():
            ...
            return (
                (self.get_mass(binary.child1) - self.get_mass(binary.child2))
    ...
    def kozai_timescale(self):
        if self.is_triple():
            ...
            P_in = self.orbital_period(binary)  # period inner binary
    ...
    def get_kozai_type(self):
        if self.is_triple():
            ...
            if t_kozai > options.kozai_type_factor * self.tend:
                return False

            t_ev = self.get_min_stellar_evolution_timescale_of_system()
            if t_kozai < options.kozai_type_factor * t_ev:
                return True
            else:
                return False
        else:
    ...
    def get_min_stellar_evolution_timescale_of_system(self, stellar_system=None):
        ...
        if stellar_system.is_star:
            ...
            t1 = self.get_min_stellar_evolution_timescale_of_system(
                stellar_system.child1
            )
            t2 = self.get_min_stellar_evolution_timescale_of_system(
                stellar_system.child2
            )
            return max(t1, t2)
    ...
    def check_OLOF(self):
        if self.triple.is_star:
            ...
            Rl2_1 = interactions.L2_radius(self, self.child1)
            Rl2_2 = interactions.L2_radius(self, self.child2)
            if options.REPORT_TRIPLE_EVOLUTION:
    ...
    def determine_time_step_wind(self, stellar_system=None):
        ...
        if stellar_system.is_star:
            ...
            if stellar_system.wind_mass_loss_rate * -1.0 > quantities.zero:
                dt = (
                    options.maximum_wind_mass_loss_factor
        ...
        if stellar_system.is_star:
            if stellar_system.time_derivative_of_radius == quantities.zero:
                ...
                if (
                    ...
                    and stellar_system.time_derivative_of_radius
                    < stellar_system.previous_time_derivative_of_radius
    ...
    def determine_time_step_kozai(self):
        ...
        if self.is_triple():
            dt = self.kozai_timescale() * options.time_step_factor_kozai
            if options.REPORT_DT:
                print("Dt_kozai = ", dt)
        else:
            dt = np.inf | units.Myr
    ...
    def e_dot_tides(self, star, m_comp, semi, eccentricity):
        ...
        k_div_T_tides = tfc.tidal_friction_constant(
            star.stellar_type,
            star.mass,
            m_comp,
            semi,
        ...
        n = interactions.corotating_spin_angular_frequency_binary(
            semi, star.mass, m_comp
        )  # mean orbital angular speed
    ...
    def determine_time_step(self):
        ...
        if (
            self.triple.child2.bin_type == "detached"
            and self.triple.child2.previous_bin_type == "stable_mass_transfer"
        ):
    ...
    def save_mean_anomalies_at_SN(
        ...
        if stellar_system.is_star:
            ...
            self.save_mean_anomalies_at_SN(
                inner_mean_anomaly, outer_mean_anomaly, stellar_system.child1
            )
            self.save_mean_anomalies_at_SN(
                inner_mean_anomaly, outer_mean_anomaly, stellar_system.child2
            )
    ...
    def adjust_system_after_supernova_kick(self):
        ...
        if self.stop_at_SN:
            if options.REPORT_SN_EVOLUTION:
                ...
                print(
                    self.triple.child2.child2.mass,
                    self.triple.child2.child2.stellar_type,
                )
        ...
        if stellar_system.is_star:
            ...
            if stopping_condition > 0:
                ...
                if not stellar_system.child1.is_star:  # child1 is a multiple
                    stopping_condition = self.resolve_stellar_interaction(
                        stellar_system.child1
                    )
                    if not stopping_condition:  # stellar interaction
                        return False
    ...
    def solve_for_partial_time_step_stable_mass_transfer(self):
        ...
        self.secular_code.evolve_model(
            self.previous_time + full_dt * self.triple.child2.part_dt_mt
        )
        ...
        self.triple.child2.part_dt_mt = 1.0
        return True
    ...
    def safety_check_time_step(self, stellar_system=None):
        ...
        if stellar_system.is_star:
            ...
            if (
                ...
                print(
                    "should this statement be here? does this give problems during mt?"
                )
            ...
            successfull_dr1, nr_dr1, star_dr1 = self.safety_check_time_step(
                stellar_system.child1
            )
        ...
        if nr_unsuccessfull > 1:
            for i_rec in range(nr_unsuccessfull):
                ...
                dr = (
                    ...
                    - star_unsuccessfull[i_rec].previous_radius
                ) / star_unsuccessfull[i_rec].radius
        else:
            dr = (
    ...
    def check_stopping_conditions_stellar(self, stellar_system=None):
        ...
        if self.is_triple(stellar_system):
            ...
            if (
                self.has_donor(stellar_system) or self.has_OLOF_donor(stellar_system)
            ) and (
    ...
    def evolve_model(self, tend):
        ...
        if options.REPORT_DEBUG or options.MAKE_PLOTS:
            ...
            spin1_array.append(
                self.triple.child2.child1.spin_angular_frequency.value_in(
                    1.0 / units.Myr
                )
            )
            spin2_array.append(
                self.triple.child2.child2.spin_angular_frequency.value_in(
                    1.0 / units.Myr
                )
            )
            spin3_array.append(
                self.triple.child1.spin_angular_frequency.value_in(1.0 / units.Myr)
            )
            ...
            moi1_array.append(
                self.triple.child2.child1.moment_of_inertia_of_star.value_in(
                    units.RSun**2 * units.MSun
                )
            )
            moi2_array.append(
                self.triple.child2.child2.moment_of_inertia_of_star.value_in(
                    units.RSun**2 * units.MSun
                )
            )
            moi3_array.append(
                self.triple.child1.moment_of_inertia_of_star.value_in(
                    units.RSun**2 * units.MSun
                )
            )
            RL1, RL2, RL3 = self.secular_code.give_roche_radii(self.triple)
        ...
        include_inner_RLOF_term_initial = (
            self.secular_code.parameters.include_inner_RLOF_terms
        )
        include_outer_RLOF_term_initial = (
        ...
        while self.triple.time < self.tend:
            ...
            if self.instantaneous_evolution is False:
                ...
                previous_argument_of_pericenter_in = (
                    self.triple.child2.argument_of_pericenter
                )
                previous_longitude_of_ascending_node_in = (
                    self.triple.child2.longitude_of_ascending_node
                )
                ...
                if (
                    ...
                    self.triple.child2.previous_argument_of_pericenter_in = (
                        previous_argument_of_pericenter_in
                    )
                    self.triple.child2.previous_longitude_of_ascending_node_in = (
                        previous_longitude_of_ascending_node_in
                    )
