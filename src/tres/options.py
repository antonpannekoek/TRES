...
maximum_time_step_factor = 100.0
maximum_time_step_factor_after_stable_mt = 5.0
...
time_step_factor_kozai = (
    0.025  # 0.2*0.1, 0.2-> for error in kozai timescale, 0.1-> 10 steps per cycle
)
kozai_type_factor = 10.0
