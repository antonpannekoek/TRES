...
class SecularTripleInterface(CodeInterface):
    ...
    def evolve():
        ...
        function.addParameter(
            "m1_convective_envelope", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "m2_convective_envelope", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "m3_convective_envelope", dtype="float64", direction=function.IN
        )
        ...
        function.addParameter(
            "R1_convective_envelope", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "R2_convective_envelope", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "R3_convective_envelope", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "luminosity_star1", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "luminosity_star2", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "luminosity_star3", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "spin_angular_frequency1", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "spin_angular_frequency2", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "spin_angular_frequency3", dtype="float64", direction=function.IN
        )
        ...
        function.addParameter(
            "gyration_radius_star1", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "gyration_radius_star2", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "gyration_radius_star3", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "moment_of_inertia_star1", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "moment_of_inertia_star2", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "moment_of_inertia_star3", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "moment_of_inertia_dot_star1", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "moment_of_inertia_dot_star2", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "moment_of_inertia_dot_star3", dtype="float64", direction=function.IN
        )
        ...
        function.addParameter(
            "wind_mass_loss_rate_star1", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "wind_mass_loss_rate_star2", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "wind_mass_loss_rate_star3", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "time_derivative_of_radius_star1", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "time_derivative_of_radius_star2", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "time_derivative_of_radius_star3", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "inner_mass_transfer_rate", dtype="float64", direction=function.IN
        )
        function.addParameter(
            "outer_mass_transfer_rate", dtype="float64", direction=function.IN
        )
        function.addParameter(
        ...
        function.addParameter(
            "inner_accretion_efficiency_mass_transfer",
            dtype="float64",
            direction=function.IN,
        )
        function.addParameter(
            "outer_accretion_efficiency_mass_transfer",
            dtype="float64",
            direction=function.IN,
        )
        function.addParameter(
            "inner_specific_AM_loss_mass_transfer",
            dtype="float64",
            direction=function.IN,
        )
        function.addParameter(
            "outer_specific_AM_loss_mass_transfer",
            dtype="float64",
            direction=function.IN,
        )
        function.addParameter(
        ...
        function.addParameter(
            "inner_spin_angular_momentum_wind_accretion_efficiency_child2_to_child1",
            dtype="float64",
            direction=function.IN,
        )
        function.addParameter("t", dtype="float64", direction=function.IN)
        function.addParameter(
            "global_time_step", dtype="float64", direction=function.IN
        )
        ...
        function.addParameter(
            "spin_angular_frequency1_output", dtype="float64", direction=function.OUT
        )
        function.addParameter(
            "spin_angular_frequency2_output", dtype="float64", direction=function.OUT
        )
        function.addParameter(
            "spin_angular_frequency3_output", dtype="float64", direction=function.OUT
        )
        ...
        function.addParameter(
            "delta_e_in_output", dtype="float64", direction=function.OUT
        )
        function.addParameter("INCL_in_output", dtype="float64", direction=function.OUT)
        function.addParameter(
            "INCL_out_output", dtype="float64", direction=function.OUT
        )
        function.addParameter(
            "INCL_in_out_output", dtype="float64", direction=function.OUT
        )
        ...
        function.addParameter(
            "root_finding_flag", dtype="int32", direction=function.OUT
        )
    ...
    def compute_orbital_vectors_from_orbital_elements():
        ...
        function.addParameter(
            "e1_vec_x", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "e1_vec_y", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "e1_vec_z", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "e2_vec_x", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "e2_vec_y", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "e2_vec_z", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "h1_vec_x", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "h1_vec_y", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "h1_vec_z", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "h2_vec_x", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "h2_vec_y", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "h2_vec_z", dtype="float64", direction=function.OUT, description=""
        )
    ...
    def compute_orbital_elements_from_orbital_vectors():
        ...
        function.addParameter("m3", dtype="float64", direction=function.IN)
        function.addParameter(
            "e1_vec_x", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "e1_vec_y", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "e1_vec_z", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "e2_vec_x", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "e2_vec_y", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "e2_vec_z", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "h1_vec_x", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "h1_vec_y", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "h1_vec_z", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "h2_vec_x", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "h2_vec_y", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "h2_vec_z", dtype="float64", direction=function.IN, description=""
        )
    ...
    def compute_effect_of_SN_on_orbital_vectors():
        ...
        function.addParameter(
            "Vkick1_vec_x", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "Vkick1_vec_y", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "Vkick1_vec_z", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "Vkick2_vec_x", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "Vkick2_vec_y", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "Vkick2_vec_z", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "Vkick3_vec_x", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "Vkick3_vec_y", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "Vkick3_vec_z", dtype="float64", direction=function.IN, description=""
        )
        ...
        function.addParameter(
            "f1", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "f2", dtype="float64", direction=function.IN, description=""
        )
        function.addParameter(
            "V1_prime_x", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "V1_prime_y", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "V1_prime_z", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "V2_prime_x", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "V2_prime_y", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "V2_prime_z", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "V3_prime_x", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "V3_prime_y", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "V3_prime_z", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "e1_vec_x_p", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "e1_vec_y_p", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "e1_vec_z_p", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "e2_vec_x_p", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "e2_vec_y_p", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "e2_vec_z_p", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "h1_vec_x_p", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "h1_vec_y_p", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "h1_vec_z_p", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "h2_vec_x_p", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "h2_vec_y_p", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "h2_vec_z_p", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "cos_phi1", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "cos_phi2", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "R", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "v_sys", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "r1dotv1", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "r1dotvk", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "v1dotvk", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "r1dotvsys", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "v1dotvsys", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "r2dot2", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "r2dotvsys", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "v2dotvsys", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "r1dotr2", dtype="float64", direction=function.OUT, description=""
        )
        function.addParameter(
            "r1dotv2", dtype="float64", direction=function.OUT, description=""
        )
        function.result_type = "float64"
        return function
    ...
    def a_out_div_a_in_dynamical_stability():
        ...
        function.addParameter(
            "stability_limit_specification", dtype="int32", direction=function.IN
        )
        function.result_type = "float64"
        return function
    ...
    def roche_radius():
        ...
        function.addParameter(
            "roche_radius_specification", dtype="int32", direction=function.IN
        )
        function.result_type = "float64"
        return function
    ...
    def get_relative_tolerance():
        ...
        function.addParameter(
            ...
            description="Relative tolerance, default 1e-10",
        )
        function.result_type = "int32"
        return function
    ...
    def get_threshold_value_of_e_in_for_setting_tidal_e_in_dot_zero():
        function = LegacyFunctionSpecification()
        function.addParameter(
            "value", dtype="float64", direction=function.OUT, description=""
        )
        function.result_type = "int32"
        return function
    ...
    def set_threshold_value_of_e_in_for_setting_tidal_e_in_dot_zero():
        function = LegacyFunctionSpecification()
        function.addParameter(
            "value", dtype="float64", direction=function.IN, description=""
        )
        function.result_type = "int32"
        return function
    ...
    def get_linear_solver():
        function = LegacyFunctionSpecification()
        function.addParameter(
            "value", dtype="int32", direction=function.OUT, description="linear solver"
        )
        function.result_type = "int32"
        return function
    ...
    def set_linear_solver():
        function = LegacyFunctionSpecification()
        function.addParameter(
            "value", dtype="int32", direction=function.IN, description="linear solver"
        )
        function.result_type = "int32"
        return function
    ...
    def get_equations_of_motion_specification():
        function = LegacyFunctionSpecification()
        function.addParameter(
            "value", dtype="int32", direction=function.OUT, description="..."
        )
        function.result_type = "int32"
        return function
    ...
    def set_equations_of_motion_specification():
        function = LegacyFunctionSpecification()
        function.addParameter(
            "value", dtype="int32", direction=function.IN, description="..."
        )
        function.result_type = "int32"
        return function
    ...
    def get_check_for_dynamical_stability():
        function = LegacyFunctionSpecification()
        function.addParameter(
            "value", dtype="bool", direction=function.OUT, description="..."
        )
        function.result_type = "int32"
        return function
    ...
    def set_check_for_dynamical_stability():
        function = LegacyFunctionSpecification()
        function.addParameter(
            "value", dtype="bool", direction=function.IN, description="..."
        )
        function.result_type = "int32"
        return function
    ...
    def set_include_quadrupole_terms():
        ...
        function.addParameter(
            ...
            dtype="bool",
            direction=function.IN,
            description="Whether or not to include quadrupole terms in the secular equations of motion",
        )
        function.result_type = "int32"
        return function
    ...
    def set_include_octupole_terms():
        ...
        function.addParameter(
            ...
            dtype="bool",
            direction=function.IN,
            description="Whether or not to include octupole terms in the secular equations of motion",
        )
        function.result_type = "int32"
        return function
    ...
    def get_include_1PN_inner_terms():
        ...
        function.addParameter(
            ...
            dtype="bool",
            direction=function.OUT,
            description="Include 1PN inner binary terms in the equations of motion",
        )
        function.result_type = "int32"
        return function
    ...
    def get_include_1PN_outer_terms():
        ...
        function.addParameter(
            ...
            dtype="bool",
            direction=function.OUT,
            description="Include 1PN outer binary terms in the equations of motion",
        )
        function.result_type = "int32"
        return function
    ...
    def get_include_1PN_inner_outer_terms():
        ...
        function.addParameter(
            ...
            dtype="bool",
            direction=function.OUT,
            description="Include 1PN 'interaction terms' in the equations of motion",
        )
        function.result_type = "int32"
        return function
    ...
    def get_include_25PN_inner_terms():
        ...
        function.addParameter(
            ...
            dtype="bool",
            direction=function.OUT,
            description="Include 2.5PN inner binary terms in the equations of motion",
        )
        function.result_type = "int32"
        return function
    ...
    def get_include_25PN_outer_terms():
        ...
        function.addParameter(
            ...
            dtype="bool",
            direction=function.OUT,
            description="Include 2.5PN outer binary terms in the equations of motion",
        )
        function.result_type = "int32"
        return function
    ...
    def set_include_inner_tidal_terms():
        ...
        function.addParameter(
            ...
            dtype="bool",
            direction=function.IN,
            description="Whether or not to include the effects of tides in the inner binary system",
        )
        function.result_type = "int32"
        return function
    ...
    def set_include_outer_tidal_terms():
        ...
        function.addParameter(
            ...
            dtype="bool",
            direction=function.IN,
            description="Whether or not to include the effects of tides in the outer binary system",
        )
        function.result_type = "int32"
        return function
...
class SecularTriple(InCodeComponentImplementation):
    ...
    def __init__(self, **options):
        InCodeComponentImplementation.__init__(
            self, SecularTripleInterface(**options), **options
        )
    ...
    def define_parameters(self, object):
        ...
        object.add_method_parameter(
            "get_verbose", "set_verbose", "verbose", "..", default_value=True
        )
    ...
    def check_for_dynamical_stability(self):
        ...
        for index_triple, triple in enumerate(self.triples):
            inner_binary, outer_binary, star1, star2, star3 = give_binaries_and_stars(
                self, triple
            )
            (
                m1,
                ...
                LAN_in,
                LAN_out,
            ) = give_stellar_masses_radii_and_binary_parameters(
                self, star1, star2, star3, inner_binary, outer_binary, triple
            )
            ...
            a_out_div_a_in_dynamical_stability = (
                self.a_out_div_a_in_dynamical_stability(
                    ...
                    e_in,
                    e_out,
                    triple.relative_inclination,
                    self.parameters.stability_limit_specification,
                )
            )
            if a_out / a_in <= a_out_div_a_in_dynamical_stability:
                if self.parameters.verbose == True:
                    print(
                        "SecularTriple -- triple system is dynamically unstable: a_out/a_in = ",
                        a_out / a_in,
                        ", whereas for dynamical stability, a_out/a_in should be > ",
                        a_out_div_a_in_dynamical_stability,
                    )
    ...
    def check_for_semisecular_regime(self):
        ...
        for index_triple, triple in enumerate(self.triples):
            ...
            check_for_semisecular_regime_parameter = (
                self.parameters.check_for_semisecular_regime_parameter
            )
            a_out_div_a_in_semisecular_regime = self.a_out_div_a_in_semisecular_regime(
                m1, m2, m3, e_in, e_out, check_for_semisecular_regime_parameter
            )
            if a_out / a_in <= a_out_div_a_in_semisecular_regime:
                if self.parameters.verbose == True:
                    print(
                        "SecularTriple -- triple system is within the semisecular regime: a_out/a_in = ",
                        a_out / a_in,
                        "; a_out/a_in for semisecular regime: ",
                        a_out_div_a_in_semisecular_regime,
                    )
    ...
    def evolve_model(self, end_time):
        ...
        for index_triple, triple in enumerate(triples):
            ...
            args, skip_integration = extract_data_and_give_args(
                self, triple, inner_binary, outer_binary, star1, star2, star3
            )
            ...
            (
                ...
                R2,
                R3,
                spin_angular_frequency1,
                spin_angular_frequency2,
                spin_angular_frequency3,
                a_in,
                a_out,
                e_in,
                e_out,
            ...
            if self.parameters.verbose == True:
                print(
                    "SecularTriple -- done; t/Myr = ",
                    end_time.value_in(units.Myr),
                    " a_in/AU=",
                    a_in.value_in(units.AU),
                    " a_out/AU=",
                    a_out.value_in(units.AU),
                    "; e_in=",
                    e_in,
                    "e_out=",
                    e_out,
                    ...
                    INCL_in,
                    " spin_freq1/day^{-1} = ",
                    spin_angular_frequency1.value_in(1.0 / units.day),
                    "LAN_in",
                    LAN_in,
                    "LAN_out",
                    LAN_out,
            ...
            if CVODE_flag == CV_ROOT_RETURN:
                ...
                if root_finding_flag == 4:
                    ...
                    if self.parameters.verbose == True:
                        print(
                            "SecularTriple -- star 1 has filled its Roche Lobe during secular integration"
                        )
                if root_finding_flag == -4:
                    star1.is_donor = False
                    if self.parameters.verbose == True:
                        print(
                            "SecularTriple -- star 1 no longer fills its Roche Lobe during secular integration"
                        )
                ...
                if root_finding_flag == 5:
                    ...
                    if self.parameters.verbose == True:
                        print(
                            "SecularTriple -- star 2 has filled its Roche Lobe during secular integration"
                        )
                if root_finding_flag == -5:
                    star2.is_donor = False
                    if self.parameters.verbose == True:
                        print(
                            "SecularTriple -- star 2 no longer fills its Roche Lobe during secular integration"
                        )
                    self.evolve_further_after_root_was_found = True
                ...
                if root_finding_flag == 6:
                    ...
                    if self.parameters.verbose == True:
                        print(
                            "SecularTriple -- star 3 has filled its Roche Lobe during secular integration"
                        )
                if root_finding_flag == -6:
                    star3.is_donor = False
                    if self.parameters.verbose == True:
                        print(
                            "SecularTriple -- star 3 no longer fills its Roche Lobe during secular integration"
                        )
                    self.evolve_further_after_root_was_found = True
            ...
            if self.evolve_further_after_root_was_found == True:
                ...
                new_secular_time_step = (
                    original_time_step - old_secular_time_step
                )  ### the remaining time that the secular code should integrate for
                new_end_time = self.model_time + new_secular_time_step

                if (
                    self.take_into_account_RLOF_after_no_longer_filling_Roche_lobe
                    == False
                ):
                    string = "NOT"
                else:
                ...
                if self.parameters.verbose == True:
                    print(
                        "SecularTriple -- root was found at t = ",
                        self.model_time,
                        "; integrating further until end time t = ",
                        new_end_time,
                        ", specified from triple.py; RLOF is ",
                        string,
                        " taken into account.",
                    )
    ...
    def give_roche_radii(self, triple):
        ...
        spin_angular_frequency_inner_orbit_periapse = numpy.sqrt(
            constants.G * (m1 + m2) * (1.0 + e_in) / (rp_in**3)
        )
        spin_angular_frequency_outer_orbit_periapse = numpy.sqrt(
            constants.G * (m1 + m2 + m3) * (1.0 + e_out) / (rp_out**3)
        )
        ...
        R_L_star1 = self.roche_radius(
            rp_in, m1 / m2, e_in, f1, self.parameters.roche_radius_specification
        )
        R_L_star2 = self.roche_radius(
            rp_in, m2 / m1, e_in, f2, self.parameters.roche_radius_specification
        )
        R_L_star3 = self.roche_radius(
            rp_out,
            m3 / (m1 + m2),
            e_out,
            f3,
            self.parameters.roche_radius_specification,
        )

        return R_L_star1, R_L_star2, R_L_star3

    def compute_effect_of_SN_on_triple(
        self,
        Vkick_1,
        Vkick_2,
        Vkick_3,
        ...
        for index_triple, triple in enumerate(triples):
            ...
            (
                ...
                h_out_vec_y,
                h_out_vec_z,
            ) = self.compute_orbital_vectors_from_orbital_elements(
                m1,
                m2,
                m3,
                a_in,
            ...
            (
                ...
                r1dotr2,
                r1dotv2,
            ) = self.compute_effect_of_SN_on_orbital_vectors(
                m1,
                m2,
                m3,
                e_in_vec_x,
            ...
            V1_prime = [
                V1_prime_x.value_in(unit_v),
                V1_prime_y.value_in(unit_v),
                V1_prime_z.value_in(unit_v),
            ] | unit_v
            V2_prime = [
                V2_prime_x.value_in(unit_v),
                V2_prime_y.value_in(unit_v),
                V2_prime_z.value_in(unit_v),
            ] | unit_v
            V3_prime = [
                V3_prime_x.value_in(unit_v),
            ...
            (
                ...
                LAN_in_prime,
                LAN_out_prime,
            ) = self.compute_orbital_elements_from_orbital_vectors(
                m1 - delta_m_1,
                m2 - delta_m_2,
                m3 - delta_m_3,
                e_in_vec_x_prime,
            ...
            if self.parameters.verbose == True:
                print(
                    "POST orb",
                    a_in_prime.value_in(units.AU),
                    a_out_prime.value_in(units.AU),
                    e_in_prime,
                    e_out_prime,
                    INCL_rel_prime,
                    AP_in_prime,
...
def print_CVODE_output(self, CVODE_flag):
    if self.parameters.verbose == False:
        return
    ...
    if CVODE_flag == CV_SUCCESS:
        ...
        print(
            "SecularTriple -- (recoverable) warnings occurred during ODE integration."
        )
    if CVODE_flag < 0:
        ...
        print(
            "SecularTriple -- unrecoverable error occurred during secular integration (CVODE_flag ",
            str(CVODE_flag),
            "): ",
            message,
        )
...
def give_stellar_masses_radii_and_binary_parameters(
    self, star1, star2, star3, inner_binary, outer_binary, triple=None
):
    ...
    if triple == None:
        ...
        if self.parameters.verbose == True:
            print(
                "SecularTriple -- warning: relative inclination is being set zero in method give_stellar_masses_radii_and_binary_parameters"
            )
    else:
...
def extract_data_and_give_args(
    self, triple, inner_binary, outer_binary, star1, star2, star3
):
    parameters = self.parameters
    skip_integration = (
        False  ### if True, no integration will be done in evolve function
    )
    ...
    if R1 >= RL1 and star1.is_donor == False:
        if self.parameters.verbose == True:
            print(
                "SecularTriple -- warning: R1>=RL1 at initialisation while star1.is_donor = False; effects of mass transfer on the orbit will not be taken into account."
            )
        self.take_into_account_RLOF_after_no_longer_filling_Roche_lobe = False
    if R2 >= RL2 and star2.is_donor == False:
        if self.parameters.verbose == True:
            print(
                "SecularTriple -- warning: R2>=RL2 at initialisation while star2.is_donor = False; effects of mass transfer on the orbit will not be taken into account."
            )
        self.take_into_account_RLOF_after_no_longer_filling_Roche_lobe = False
    if R3 >= RL3 and star3.is_donor == False:
        if self.parameters.verbose == True:
            print(
                "SecularTriple -- warning: R3>=RL3 at initialisation while star3.is_donor = False; effects of mass transfer on the orbit will not be taken into account."
            )
        self.take_into_account_RLOF_after_no_longer_filling_Roche_lobe = False
    ...
    if parameters.check_for_dynamical_stability_at_initialisation == True:
        a_out_div_a_in_dynamical_stability = self.a_out_div_a_in_dynamical_stability(
            m1,
            m2,
            m3,
            a_in,
        ...
        if a_out / a_in <= a_out_div_a_in_dynamical_stability:
            if self.parameters.verbose == True:
                print(
                    'SecularTriple -- code parameter "check_for_dynamical_stability_at_initialisation" = True'
                )
                print(
                    "SecularTriple -- given system is initially dynamically unstable: a_out/a_in = ",
                    a_out / a_in,
                    ", whereas for dynamical stability, a_out/a_in should be > ",
                    a_out_div_a_in_dynamical_stability,
                )
    ...
    if parameters.check_for_semisecular_regime_at_initialisation == True:
        ...
        if a_out / a_in <= a_out_div_a_in_semisecular_regime:
            if self.parameters.verbose == True:
                print(
                    'SecularTriple -- code parameter "check_for_semisecular_regime_at_initialisation" = True'
                )
                print(
                    "SecularTriple -- given system is initially in semisecular regime: a_out/a_in = ",
                    a_out / a_in,
                    "; a_out/a_in for semisecular regime: ",
                    a_out_div_a_in_semisecular_regime,
                )
    ...
    wind_mass_loss_rate_star1 = wind_mass_loss_rate_star2 = (
        wind_mass_loss_rate_star3
    ...
    if parameters.include_linear_mass_change == True:
        try:
            ...
            sys.exit(
                "SecularTriple -- mass time_derivative_of_mass is needed for all three stars if include_linear_mass_change==True! exiting"
            )
    time_derivative_of_radius_star1 = time_derivative_of_radius_star2 = (
        time_derivative_of_radius_star3
    ) = (0.0 | units.RSun / units.s)
    if parameters.include_linear_radius_change == True:
        try:
            ...
            sys.exit(
                "SecularTriple -- time_derivative_of_radius is needed for all three stars if include_linear_radius_change==True! exiting"
            )
    ...
    if parameters.include_inner_wind_terms == True:
        try:
            ...
            inner_accretion_efficiency_wind_child2_to_child1 = (
                inner_binary.accretion_efficiency_wind_child2_to_child1
            )
        except AttributeError:
            sys.exit(
                "SecularTriple -- more attributes required for inner wind! exiting"
            )
    if parameters.include_outer_wind_terms == True:
        try:
            ...
            outer_accretion_efficiency_wind_child1_to_child2 = (
                outer_binary.accretion_efficiency_wind_child1_to_child2
            )
            outer_accretion_efficiency_wind_child2_to_child1 = (
            ...
            sys.exit(
                "SecularTriple -- more attributes required for outer wind! exiting"
            )
    if parameters.include_inner_RLOF_terms == True:
        try:
            ...
            inner_mass_transfer_rate = inner_binary.mass_transfer_rate
            inner_accretion_efficiency_mass_transfer = (
                inner_binary.accretion_efficiency_mass_transfer
            )
            inner_specific_AM_loss_mass_transfer = (
                inner_binary.specific_AM_loss_mass_transfer
            )
        except AttributeError:
            sys.exit(
                "SecularTriple -- more attributes required for inner RLOF! exiting"
            )
    if parameters.include_outer_RLOF_terms == True:
        try:
            ...
            outer_accretion_efficiency_mass_transfer = (
                outer_binary.accretion_efficiency_mass_transfer
            )
            outer_specific_AM_loss_mass_transfer = (
                outer_binary.specific_AM_loss_mass_transfer
            )
        except AttributeError:
            sys.exit(
                "SecularTriple -- more attributes required for outer RLOF! exiting"
            )
    ...
    if parameters.check_for_inner_RLOF == True:
        try:
            ...
            sys.exit(
                "SecularTriple -- more attributes required for inner RLOF check! exiting"
            )
    if parameters.check_for_outer_RLOF == True:
        try:
            ...
            sys.exit(
                "SecularTriple -- more attributes required for outer RLOF check! exiting"
            )
    ...
    if parameters.include_magnetic_braking_terms == True:
        try:
            ...
            sys.exit(
                "SecularTriple -- more attributes required for magnetic braking terms! exiting"
            )

    ### spin-radius-mass coupling ###
    moment_of_inertia_star1 = moment_of_inertia_star2 = moment_of_inertia_star3 = (
        0.0 | units.MSun * units.RSun**2
    )
    moment_of_inertia_dot_star1 = moment_of_inertia_dot_star2 = (
        moment_of_inertia_dot_star3
    ...
    if (
        parameters.include_spin_radius_mass_coupling_terms_star1 == True
        or parameters.include_spin_radius_mass_coupling_terms_star2 == True
        or parameters.include_spin_radius_mass_coupling_terms_star3 == True
    ):
        try:
            spin_angular_frequency1 = star1.spin_angular_frequency
            spin_angular_frequency2 = star2.spin_angular_frequency
        ...
        #            inner_spin_angular_momentum_wind_accretion_efficiency_child2_to_child1 = inner_binary.spin_angular_momentum_wind_accretion_efficiency_child2_to_child1
            ...
            sys.exit(
                "SecularTriple -- more attributes required for spin-radius-mass coupling terms! exiting"
            )
    ...
    if parameters.include_inner_tidal_terms == True:
        ...
        if m1_convective_envelope.value_in(unit_m) < 0:
            sys.exit(
                "SecularTriple -- m1_convective_envelope must be positive! exiting"
            )
        if m2_convective_envelope.value_in(unit_m) < 0:
            sys.exit(
                "SecularTriple -- m2_convective_envelope must be positive! exiting"
            )
        if m3_convective_envelope.value_in(unit_m) < 0:
            sys.exit(
                "SecularTriple -- m3_convective_envelope must be positive! exiting"
            )

        if R1_convective_envelope.value_in(unit_l) < 0:
            sys.exit(
                "SecularTriple -- R1_convective_envelope must be positive! exiting"
            )
        if R2_convective_envelope.value_in(unit_l) < 0:
            sys.exit(
                "SecularTriple -- R2_convective_envelope must be positive! exiting"
            )
        if R3_convective_envelope.value_in(unit_l) < 0:
            sys.exit(
                "SecularTriple -- R3_convective_envelope must be positive! exiting"
            )

    if self.parameters.verbose == True:
        print(
            "SecularTriple -- initialization; a_in/AU=",
            a_in.value_in(units.AU),
            "; e_in=",
            e_in,
            "e_out=",
    ...
    args = [
        ...
        m2,
        m3,
        m1_convective_envelope,
        m2_convective_envelope,
        m3_convective_envelope,
        R1,
        R2,
        R3,
        R1_convective_envelope,
        R2_convective_envelope,
        ...
        AMC_star2,
        AMC_star3,
        gyration_radius_star1,
        gyration_radius_star2,
        gyration_radius_star3,
        moment_of_inertia_star1,
        moment_of_inertia_star2,
        moment_of_inertia_star3,
        moment_of_inertia_dot_star1,
        ...
        star2_is_donor,
        star3_is_donor,
        wind_mass_loss_rate_star1,
        wind_mass_loss_rate_star2,
        wind_mass_loss_rate_star3,
        time_derivative_of_radius_star1,
        time_derivative_of_radius_star2,
        time_derivative_of_radius_star3,
        inner_mass_transfer_rate,
