...
def create_snapshot_for_dict(triple, parameter_style):
    if parameter_style == 0:  # all available parameters
        snapshot_props = {
            ...
            "star1_stellar_type": triple[0].child2.child1.stellar_type.value_in(
                units.stellar_type
            ),
            "star1_mass_MSun": triple[0].child2.child1.mass.value_in(units.MSun),
            "star1_spin_Myr_inv": triple[
                0
            ].child2.child1.spin_angular_frequency.value_in(1.0 / units.Myr),
            "star1_rad_RSun": triple[0].child2.child1.radius.value_in(units.RSun),
            "star1_coremass_MSun": triple[0].child2.child1.core_mass.value_in(
                units.MSun
            ),
            "star1_previous_mass_MSun": triple[0].child2.child1.previous_mass.value_in(
                units.MSun
            ),
            "star1_luminosity_LSun": triple[0].child2.child1.luminosity.value_in(
                units.LSun
            ),
            "star1_temperature_K": triple[0].child2.child1.temperature.value_in(
                units.K
            ),
            "star2_is_donor": int(triple[0].child2.child2.is_donor),
            #            'star2_is_OLOF': int(triple[0].child2.child2.is_OLOF),
            "star2_stellar_type": triple[0].child2.child2.stellar_type.value_in(
                units.stellar_type
            ),
            "star2_mass_MSun": triple[0].child2.child2.mass.value_in(units.MSun),
            "star2_spin_Myr_inv": triple[
                0
            ].child2.child2.spin_angular_frequency.value_in(1.0 / units.Myr),
            "star2_rad_RSun": triple[0].child2.child2.radius.value_in(units.RSun),
            "star2_coremass_MSun": triple[0].child2.child2.core_mass.value_in(
                units.MSun
            ),
            "star2_previous_mass_MSun": triple[0].child2.child2.previous_mass.value_in(
                units.MSun
            ),
            "star2_luminosity_LSun": triple[0].child2.child2.luminosity.value_in(
                units.LSun
            ),
            "star2_temperature_K": triple[0].child2.child2.temperature.value_in(
                units.K
            ),
            "star3_is_donor": int(triple[0].child1.is_donor),
            #            'star3_is_OLOF': int(triple[0].child1.is_OLOF),
            "star3_stellar_type": triple[0].child1.stellar_type.value_in(
                units.stellar_type
            ),
            "star3_mass_MSun": triple[0].child1.mass.value_in(units.MSun),
            "star3_spin_Myr_inv": triple[0].child1.spin_angular_frequency.value_in(
                1.0 / units.Myr
            ),
            ...
            "star3_previous_mass_MSun": triple[0].child1.previous_mass.value_in(
                units.MSun
            ),
    ...
    for i, triple in enumerate(triple.history):
        ...
        if save_all_snapshots and correct_system:  # all snapshots
            ...
            df.to_csv(
                file_name_root + ".csv",
                mode="a",
                header=not os.path.exists(file_name_root + ".csv"),
            )
            if print_style == 1:
                if i == 0:
                    print(df.to_string())
...
def parse_arguments():
    ...
    parser.add_option(
        "-P",
        dest="parameter_style",
        type="int",
        default=1,
        help="parameter style - which parameters should be recorded[%default]",
    )
    parser.add_option(
        "-S", dest="print_style", type="int", default=0, help="print style [%default]"
    )
    parser.add_option(
        "-F",
        "--save_all_snapshots",
        dest="save_all_snapshots",
        action="store_true",
        default=False,
